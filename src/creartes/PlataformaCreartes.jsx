            ...
            <div className="container my-5">
                <div className="row">
                    <div className="col-md-5 offset-md-1">
                        ...
                        <ul>
                            <li className="fs-5"><b>Suma Experiencia</b> Creatividad.</li>
                            <li className="fs-5">Para que puedas realizar las fotografías de tus productos desde tu casa y <b>Con Técnicas de imagen</b>.</li>
